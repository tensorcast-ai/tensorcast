...
CREATE TABLE IF NOT EXISTS artifact_transports (
    ...
    broadcast_session_id TEXT NULL,
    broadcast_edge_id TEXT NULL,
...
CREATE INDEX IF NOT EXISTS idx_broadcast_targets_session_state
    ON broadcast_targets(session_id, state, updated_at);
CREATE INDEX IF NOT EXISTS idx_broadcast_edges_session_child_state
    ON broadcast_edges(session_id, child_worker_id, state);
