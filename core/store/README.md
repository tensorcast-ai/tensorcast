...
- Region-backed materialization (external targets):
  ...
  - `absl::StatusOr<loading::MaterializeIntoTargetResult> materialize_mapped_into_target(const DeviceKey&, const runtime::ingestion::strategy::ResolvedMaterializationPlan&, const loading::MaterializeHints&, std::optional<loading::DiskSource>)`
