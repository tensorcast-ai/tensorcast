...
Selection identity hashing helpers (logical layout, view subset, selection hash) live in
`core/common/selection_identity.h` and `core/common/selection_identity.cc`.
