...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    "attach_host_shared_region": ("tensorcast.api.store", "attach_host_shared_region"),
    ...
    "register_region": ("tensorcast.api.store", "register_region"),
    ...
    "unregister_region": ("tensorcast.api.store", "unregister_region"),
