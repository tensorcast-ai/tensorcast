...
This creates optimized assets in `../tensorcast/global_store/webui/build/`.
...
```bash
GLOBAL_STORE_UI_STATIC_DIR=/path/to/custom/build python -m tensorcast.global_store
```