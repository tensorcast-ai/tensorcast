...
class PlacementService:
    ...
    def plan_placement(
        ...
        *,
        ...
        active_workers = self.worker_repository.find_active(include_unavailable=False)
        ...
        for shard in shards:
            ...
            if not remote_candidates:
                ...
                continue
            remote = remote_candidates[shard_model.shard_idx % len(remote_candidates)]
            shard_targets.append(
                PlacementTarget(
                    plan_id=plan_id,
                    shard_idx=shard_model.shard_idx,
            ...
            [
                {
                    ...
                    "degraded_reason": shard.degraded_reason or degraded_reason or "",
                }
