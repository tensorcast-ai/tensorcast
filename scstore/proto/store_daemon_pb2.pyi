...
class RegisterModelResponse(_message.Message):
    ...
    model_size: int
    def __init__(
        self, model_path: _Optional[str] = ..., model_size: _Optional[int] = ...
    ) -> None: ...
...
class LoadModelResponse(_message.Message):
    ...
    def __init__(
        ...
        status: _Optional[_Union[LoadModelStatus, str]] = ...,
    ) -> None: ...
...
class ConfirmModelResponse(_message.Message):
    ...
    code: int
    def __init__(
        self, model_path: _Optional[str] = ..., code: _Optional[int] = ...
    ) -> None: ...
...
class VerificationRequest(_message.Message):
    ...
    def __init__(
        self,
        model_identifier: _Optional[str] = ...,
        replica_uuid: _Optional[str] = ...,
...
class ModelInfo(_message.Message):
    ...
    def __init__(
        self,
        model_identifier: _Optional[str] = ...,
        model_size_bytes: _Optional[int] = ...,
        location: _Optional[_Union[ModelLocation, str]] = ...,
...
class GpuDeviceInfo(_message.Message):
    ...
    def __init__(
        ...
        loaded_models: _Optional[_Iterable[_Union[ModelInfo, _Mapping]]] = ...,
    ) -> None: ...
...
class GetDetailedStatusResponse(_message.Message):
    ...
    def __init__(
        ...
        cpu_models: _Optional[_Iterable[_Union[ModelInfo, _Mapping]]] = ...,
        communication_info: _Optional[_Union[CommunicationInfo, _Mapping]] = ...,
        total_models_loaded: _Optional[int] = ...,
        total_model_size_bytes: _Optional[int] = ...,
...
class GetLoadedModelsResponse(_message.Message):
    ...
    def __init__(
        self,
        models: _Optional[_Iterable[_Union[LoadedModelInfo, _Mapping]]] = ...,
        total_models: _Optional[int] = ...,
        total_size_bytes: _Optional[int] = ...,
    ) -> None: ...
