...
Example
-------
    python -m scstore.global_store.webui_backend.main \
        --grpc-host 127.0.0.1 --grpc-port 50051 \
        --ui-host 0.0.0.0 --ui-port 9000

Environment variables understood by :pyclass:`scstore.global_store.config.GlobalStoreConfig`
...
from scstore.global_store.webui_backend.grpc_client import GlobalStoreClientConfig
...
def cli(argv: list[str] | None = None) -> None:  # noqa: D401
    ...
    # If the environment defines compatible variables (e.g. SCSTORE_UI_*), the
