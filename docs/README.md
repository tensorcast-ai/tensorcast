...
- **[Step3p5 Closure and Single-SOT Convergence Plan](plans/0113-step3p5-closure-and-sot-convergence.md)** - The single active execution plan for source-bound collective contract cutover, single-mint closeout, executor convergence, and legacy deletion
