...
- **Historical: [Step3p5 Closure and Single-SOT Convergence](designs/0113-step3p5-closure-and-sot-convergence.md)** - Superseded by the implemented `0114` execution record; kept only as historical closure context
- **[Collective-First Binding Realization for TP Serving Startup](designs/0114-collective-first-binding-realization-for-tp-serving-startup.md)** - Implemented audited Step3p5 closure for collective-first same-binding startup, execution-only realization ingress, and one-hash GPU-backed seal reuse; the completed companion plan has been folded back into this design and deleted
- **[Explicit Source-Bound Execution Planning and Fail-Fast Lane Selection](designs/0115-explicit-source-bound-execution-planning-and-fail-fast-lane-selection.md)** - Implemented source-bound execution closure that makes mapped and binding lane choice explicit, planner-owned, and fail-fast; the completed companion plan has been folded back into this design and deleted
- **[Post-0114 Mounted Rollout and Delete-Gate Cleanup](designs/0117-post-0114-mounted-rollout-and-delete-gate-cleanup.md)** - Follow-up design for second-family mounted rollout, broader operator-visible evidence, and cleanup after `0114` closure
- **[Post-0114 Mounted Rollout and Delete-Gate Cleanup Plan](plans/0117-post-0114-mounted-rollout-and-delete-gate-cleanup.md)** - Active post-0114 and post-0115 checklist for second-family validation, mounted evidence hardening, and delete-gate cleanup
