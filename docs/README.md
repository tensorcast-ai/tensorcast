...
- **[Process-Scoped Region-Backed Artifact Session](designs/0122-process-scoped-region-backed-artifact-session.md)** - Public SDK session for batched artifact operations over daemon-exposed, process-pinned host regions
