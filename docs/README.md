...
- **[Step3p5 Closure and Single-SOT Convergence](designs/0113-step3p5-closure-and-sot-convergence.md)** - Consolidates the remaining `0107`-`0112` undo items, delete gates, and documentation ownership into one closure design
- **[Step3p5 Closure and Single-SOT Convergence Plan](plans/0113-step3p5-closure-and-sot-convergence.md)** - Historical closure-handoff record kept for context while active execution tracking moves to the `0114` plan
- **[Collective-First Binding Realization for TP Serving Startup](designs/0114-collective-first-binding-realization-for-tp-serving-startup.md)** - Converges `Binding.realize_from(...)` onto a collective-first mixed-execution path with explicit collective, local typed, and generic residual lanes
- **[Collective-First Binding Realization for TP Serving Startup Plan](plans/0114-collective-first-binding-realization-for-tp-serving-startup.md)** - The single active total execution plan for source-bound TP startup convergence, v3 contract handoff, strict preflight, split planner/execution diagnostics, and mounted delete gates
- **[Explicit Source-Bound Execution Planning and Fail-Fast Lane Selection](designs/0115-explicit-source-bound-execution-planning-and-fail-fast-lane-selection.md)** - Removes runtime implicit fallback from source-bound mapped and binding execution by making lane choice explicit and planner-owned
- **[Explicit Source-Bound Execution Planning and Fail-Fast Lane Selection Plan](plans/0115-explicit-source-bound-execution-planning-and-fail-fast-lane-selection.md)** - Phased implementation plan for separating semantic truth from lowering artifacts, cutting execution over to explicit strategy plans, and preserving fast paths
